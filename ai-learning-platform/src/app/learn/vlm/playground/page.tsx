  ...
  const analyzeImage = async () => {
    ...
    try {
      ...
      const mockResult: AnalysisResult = {
        description: "This appears to be a scenic landscape image featuring a natural environment with various elements. The composition shows thoughtful attention to detail with good lighting and color balance. The scene creates a peaceful and visually appealing atmosphere that invites the viewer to explore its contents more thoroughly.",
        objects: [
          { name: "Sky", confidence: 0.98, bbox: [0, 0, 400, 100] },
          { name: "Trees", confidence: 0.95, bbox: [100, 150, 200, 150] },
          { name: "Ground", confidence: 0.92, bbox: [0, 250, 400, 50] },
          { name: "Clouds", confidence: 0.88, bbox: [50, 30, 100, 40] }
        ],
        colors: [
          { color: "#87CEEB", name: "Sky Blue", percentage: 35 },
          ...
          { color: "#708090", name: "Slate Gray", percentage: 5 }
        ],
        tags: ["landscape", "nature", "outdoor", "scenic", "peaceful", "natural"],
        text: []
      }
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div className="flex-1">
          <h1 className="text-3xl font-bold">Vision Playground</h1>
          <p className="text-muted-foreground">Experiment with Vision Language Models in real-time</p>
        </div>
              ...
              <div>
                ...
                {currentModel && (
                  <div className="mt-2 flex flex-wrap gap-1">
                    ...
                    <Badge variant={currentModel.cost === 'Free' ? 'default' : 'secondary'} className="text-xs">
                      {currentModel.cost}
                    </Badge>
                  </div>
                )}
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {samplePrompts.map((samplePrompt, index) => (
                    ...
                    >
                      {index < 5 ? samplePrompt.substring(0, 20) + '...' : samplePrompt.substring(0, 15) + '...'}
                    </Button>
                  ))}
                </div>
              </div>
        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-3 text-sm">
              <div className="p-3 bg-blue-50 rounded-lg">
                <p className="text-blue-700">
                  📸 Use high-quality, clear images for better analysis accuracy.
                </p>
              </div>
              <div className="p-3 bg-green-50 rounded-lg">
                <p className="text-green-700">
                  ❓ Be specific in your prompts for more detailed responses.
                </p>
              </div>
              <div className="p-3 bg-purple-50 rounded-lg">
                <p className="text-purple-700">
                  🎨 Ask about colors, emotions, or artistic elements for creative insights.
                </p>
              </div>
              <div className="p-3 bg-orange-50 rounded-lg">
                <p className="text-orange-700">
                  🔍 Request object detection or counting for analytical tasks.
                </p>
              </div>
            </CardContent>
          </Card>
              ...
              {vlmModels.map((model) => (
                <div key={model.id} className="p-3 border rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <Badge
                      variant={model.cost === 'Free' ? 'default' : 'secondary'}
                      className="text-xs"
                    >
                      {model.cost}
                    </Badge>
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              <Link href="/learn/vlm/examples">
                <Button variant="outline" className="w-full justify-start">
                  <FileText className="w-4 h-4 mr-2" />
                  View Examples
                </Button>
              </Link>
              <Link href="/learn/vlm/models">
                <Button variant="outline" className="w-full justify-start">
