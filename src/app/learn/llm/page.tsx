...
import { BookOpen, Lock, CheckCircle, Clock, Trophy, Zap, Star, ChevronRight } from 'lucide-react';
...
export default function LLMLearningPage() {
  ...
  const [learningLevels, setLearningLevels] = useState<LearningLevel[]>([
    {
      id: 'basics',
      title: 'LLM Basics',
      description: 'Learn the fundamentals of Large Language Models, API setup, and basic text generation.',
      level: 1,
      requiredXp: 0,
      isUnlocked: true,
      isCompleted: true,
    ...
    },
    {
      ...
      description: 'Master system messages, temperature control, and effective prompting techniques.',
      level: 2,
      requiredXp: 100,
      isUnlocked: true,
      isCompleted: false,
    ...
    },
    {
      ...
      description: 'Advanced techniques: few-shot learning, chain-of-thought, function calling.',
      level: 3,
      requiredXp: 300,
      isUnlocked: true,
      isCompleted: false,
    ...
    },
    {
      ...
      description: 'Build robust LLM applications with error handling and optimization.',
      level: 4,
      requiredXp: 600,
      isUnlocked: false,
      isCompleted: false,
    ...
    },
    {
      ...
      description: 'Fine-tune models and deploy enterprise-grade LLM solutions.',
      level: 5,
      requiredXp: 1000,
      isUnlocked: false,
      isCompleted: false,
  ...
  const getLevelIcon = (level: LearningLevel) => {
    ...
    if (level.isUnlocked) return <BookOpen className="w-6 h-6 text-blue-600" />;
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div>
              <h1 className="text-3xl font-bold mb-2">LLM Learning Path</h1>
              <p className="text-blue-100">Master Large Language Models step by step</p>
            </div>
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div className={`w-12 h-12 rounded-full flex items-center justify-center ${
                      ...
                      level.isUnlocked ? 'bg-blue-100' : 'bg-gray-100'
                    }`}>
                      {getLevelIcon(level)}
                    </div>
                    <div>
